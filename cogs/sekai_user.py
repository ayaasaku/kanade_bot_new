...
class SekaiUserCog(commands.Cog, name='sekai_user'):
    ...
    async def profile(self, interaction: discord.Interaction, option:str, person: discord.User = None, import_player_id: str = None):
        await interaction.response.defer(ephemeral=True)
        if import_player_id == None:
    ...
    async def rank(self, interaction: discord.Interaction, option:str, person: discord.User = None, import_player_id: str = None):
        if import_player_id == None:
            db = await aiosqlite.connect("kanade_data.db")
            cursor = await db.cursor()
